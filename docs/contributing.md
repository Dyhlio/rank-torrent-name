...
1. Go to the [RTN GitHub repository](https://github.com/Dyhlio/rank-torrent-name).
...
- Check the [repository](https://github.com/Dyhlio/rank-torrent-name) for updates and proposed changes
