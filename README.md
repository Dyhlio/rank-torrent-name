...
<img src="https://img.shields.io/github/actions/workflow/status/Dyhlio/rank-torrent-name/battery.yml?branch=main" alt="GitHub Actions Workflow Status" />

<img src="https://img.shields.io/github/license/Dyhlio/rank-torrent-name" alt="GitHub License" />
...
```bash
pip install git+https://github.com/Dyhlio/rank-torrent-name.git
```

For development, clone the repository and install the dependencies with Poetry:

```bash
git clone https://github.com/Dyhlio/rank-torrent-name.git
...
Find the source and proposed changes on [GitHub](https://github.com/Dyhlio/rank-torrent-name).
