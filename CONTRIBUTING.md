...
- Go to the [RTN GitHub repository](https://github.com/Dyhlio/rank-torrent-name).
...
Read the [FAQ](docs/users/faq.md) for configuration guidance and check the [repository](https://github.com/Dyhlio/rank-torrent-name) for updates.
